      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14 reveal">
          ...
          <p className="text-text-secondary text-base sm:text-lg mt-3 max-w-xl mx-auto">
            Please carefully review the branch and year eligibility criteria before forming your team of three.
          </p>
        </div>
          ...
          <div className="reveal card-warm p-8 bg-surface border-2 border-sage/40 flex flex-col justify-between">
            <div>
              ...
              <p className="text-text-secondary text-xs sm:text-sm leading-relaxed mb-5">
                Students from any non-IT discipline are enthusiastically invited across all academic years:
              </p>
            ...
            <div className="mt-6 pt-4 border-t border-border-subtle flex items-center gap-2 text-sage text-xs font-display font-bold">
              <span>✓</span>
              <span>Full batch eligibility for all non-IT branches</span>
            </div>
          </div>

          {/* IT Branches */}
          <div className="reveal reveal-delay-1 card-warm p-8 bg-surface border-2 border-caramel/40 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between gap-4 mb-4">
                <span className="text-3xl">🎯</span>
                <span className="badge-caramel text-xs">3rd Year Students ONLY</span>
              </div>
              <h3 className="font-serif font-bold text-coffee-950 text-2xl mb-1">
                IT Branches
              </h3>
              <p className="text-caramel font-display font-bold text-sm mb-4">
                Strictly Restricted to 3rd-Year Students
              </p>
              <p className="text-text-secondary text-xs sm:text-sm leading-relaxed mb-5">
                For computing and software departments, eligibility is reserved exclusively for the 3rd-year cohort:
              </p>
              <div className="p-4 rounded-xl bg-surface-soft border border-border-subtle text-xs sm:text-sm text-coffee-900 space-y-2">
                <p>
                  <strong>Eligible Departments:</strong> Computer Science (CSE), Information Science (ISE), AI &amp; ML, AI &amp; Data Science, etc.
                </p>
                <p>
                  <strong>Academic Years:</strong> 3rd Year Students Only
                </p>
              </div>
            </div>
            <div className="mt-6 pt-4 border-t border-border-subtle flex items-center gap-2 text-caramel font-display font-bold text-xs">
              <span>●</span>
              <span>1st, 2nd, and 4th years of IT branches are not eligible</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {TEAM_REQUIREMENTS.map((req, i) => {
            const delay = ["", "reveal-delay-1", "reveal-delay-2", "reveal-delay-3", "reveal-delay-4"][i];
            return (
              <div
                key={req.title}
                className={`reveal ${delay} card-warm p-5 text-center flex flex-col items-center justify-between ${
                  req.urgent ? "border-amber-warm/40 bg-amber-soft/50" : ""
                }`}
              >
                <div className="text-3xl mb-2">{req.icon}</div>
                <div>
                  <h4 className="font-serif font-bold text-coffee-950 text-sm mb-1 leading-snug">
                    {req.title}
                  </h4>
    ...
    <section id="register" className="relative z-10 py-24 px-6 overflow-hidden" aria-labelledby="register-heading">
      <div className="max-w-3xl mx-auto text-center relative z-10">
        ...
        <h2 id="register-heading" className="section-heading mb-3">
          Secure Your Team's Spot at <span className="font-serif italic text-caramel">DataThon 2026</span>
        </h2>
        <p className="text-text-secondary text-base sm:text-lg mb-8 max-w-xl mx-auto">
          Confirm your team of three. Slots are assigned on a strict first-come, first-served basis.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-2.5 mb-8">
          {[
            "⚡ 15 Teams Only",
            "⏱ First 15 Verified Teams Confirmed",
            "👥 Exactly 3 Members / Team",
          ].map((chip) => (
            <span
              key={chip}
        ...
        <div className="mb-10 max-w-xl mx-auto">
          <AlertBanner
            items={[
              "3 MEMBERS PER TEAM",
              "NON-IT (ALL YEARS) OR IT (3RD YEAR ONLY)",
              "FIRST 15 TEAMS ONLY",
            ]}
          />
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-14 reveal">
          ...
          <p className="text-text-secondary text-base sm:text-lg mt-3">
            Have questions regarding eligibility, team formation, or event logistics? Contact us directly.
          </p>
        </div>
    ...
    <footer className="relative z-10 bg-[#F5F0E6] border-t border-border-subtle py-12 px-6 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-text-muted text-xs leading-relaxed max-w-lg mx-auto">
          <strong>Eligibility Summary:</strong> Non-IT Branches (All Years) &amp; IT Branches (3rd Year Only). Maximum 15 teams of 3 members each.
        </p>
